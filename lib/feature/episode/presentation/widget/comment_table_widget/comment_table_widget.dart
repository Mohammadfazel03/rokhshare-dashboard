...
import 'package:dashboard/feature/episode/presentation/widget/comment_table_widget/entity/comment_data_grid.dart';
...
class CommentTableWidget extends StatefulWidget {
  ...
  const CommentTableWidget({super.key, required this.episodeId});
...
class _CommentTableWidgetState extends State<CommentTableWidget> {
  ...
  void initState() {
    ...
    _dataGrid = CommentDataGrid(
        ...
        mediaId: widget.episodeId);
    BlocProvider.of<CommentTableCubit>(context)
        .getData(episodeId: widget.episodeId);
                      ...
                      child: PaginationWidget(
                          ...
                          onChangePage: (page) {
                            if (BlocProvider.of<CommentTableCubit>(context)
                              ...
                              BlocProvider.of<CommentTableCubit>(context)
                                  .getData(
                                      page: page, episodeId: widget.episodeId);
                            }
                          }),
                    ),
                  ),
