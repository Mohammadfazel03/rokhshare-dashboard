...
class MovieUploadSectionWidget extends StatelessWidget {
  final double height;

  const MovieUploadSectionWidget({super.key, required this.height});
  ...
  Widget uploadedFile(Uint8List? thumbnailDataUrl) {
