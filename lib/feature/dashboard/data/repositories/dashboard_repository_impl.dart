...
class DashboardRepositoryImpl extends DashboardRepository {
  ...
  DashboardRepositoryImpl({required DashboardApiService apiService}) : _api = apiService;
    ...
    try {
      ...
      if (e is DioException) {
        ...
        if (exception.response?.statusCode == 403) {
          return const DataFailed('این نشست غیر فعال شده است. لطفا دوباره وارد شوید.', code: 403);
        }
